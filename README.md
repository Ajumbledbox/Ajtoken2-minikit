...
Reads your Coinbase CSV export and shows your current portfolio value
using live prices from CoinMarketCap. FIFO lot tracking with realized
and unrealized P/L in CAD.
